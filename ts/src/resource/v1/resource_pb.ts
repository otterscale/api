 ...
 */
export type DescribeRequest = Message<"otterscale.resource.v1.DescribeRequest"> & {
  /**
   * The target Kubernetes cluster identifier.
   *
   * @generated from field: string cluster = 1;
 ...
 */
export type DescribeResponse = Message<"otterscale.resource.v1.DescribeResponse"> & {
  /**
